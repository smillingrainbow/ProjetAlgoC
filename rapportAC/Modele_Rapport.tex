...
\paragraph{}
ListeCluster est une liste cha\^inée qui a pour implémentation :
\begin{figure}[!h]
...
\caption{Implémentation de la structure ListeCluster}
\end{figure}
...
Ci-dessous l'implémentation de la structure Cluster. 
\begin{figure}[!h]
\texttt{Cluster = \^\,Place;}
\paragraph{}
 \texttt{ Place = enregistrement 
...
\caption{Implémentation de la structure Cluster}
\end{figure}
